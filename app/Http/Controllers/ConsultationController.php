...
class ConsultationController extends Controller
{
    public function index()
    {
        ...
        return response()->json(['message' => 'List of Consultation INDEX', 'data' => $data]);
    }
    ...
    //     return response()->json(['message' => 'Consultation Found in ShowlIST', 'data' => $data]);
    // }
    ...
    public function show(string $id)
    {
        ...
        if ($Consultation) {
            return response()->json(['message' => 'Consultation show found', 'data' => $Consultation]);
        } else {
            return response()->json(['message' => 'Consultation show not found']);
        }
    }
